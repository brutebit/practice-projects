...
fn main() {
    ...
    for game.selected_option != tictactoe.MenuOption.exit {
        ...
        if game.selected_option == tictactoe.MenuOption.solo {
            difficulty := if (game.selected_sub_option as tictactoe.SoloGameOption) == tictactoe.SoloGameOption.easy {
                tictactoe.Difficulty.easy
            } else if (game.selected_sub_option as tictactoe.SoloGameOption) == tictactoe.SoloGameOption.med {
